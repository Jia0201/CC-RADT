...
先解析 `AI_TEAMS_ROOT`：目标项目存在 `.claude/ai-teams/index/ENTRY.md` 时取 `.claude/ai-teams`，否则取当前 AI-Teams 根目录。执行时读取 `.claude/ai-teams/index/ENTRY.md`、`.claude/ai-teams/rule/agents/dev-frontend-web.md`、`.claude/ai-teams/prompts/agents/dev-frontend-web/index.md`、`.claude/ai-teams/agents/dev-frontend-web/dev-frontend-web.md`、`.claude/ai-teams/security/agent-playbooks/dev-frontend-web.md`、`.claude/ai-teams/project/index.md` 和当前任务单。文档引用必须使用真实路径或标准 Markdown 链接。
...
1. 读取 `.claude/ai-teams/rule/agents/dev-frontend-web.md`、任务范围、`.claude/ai-teams/project/ui-style.md`、`.claude/ai-teams/project/api-contracts.md` 和必要源码。
