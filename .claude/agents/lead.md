...
先解析 `AI_TEAMS_ROOT`：目标项目存在 `.claude/ai-teams/index/ENTRY.md` 时取 `.claude/ai-teams`，否则取当前 AI-Teams 根目录。执行时读取 `.claude/ai-teams/index/ENTRY.md`、`.claude/ai-teams/rule/agents/lead.md`、`.claude/ai-teams/prompts/agents/lead/index.md`、`.claude/ai-teams/agents/lead/lead.md`、`.claude/ai-teams/security/agent-playbooks/lead.md`、`.claude/ai-teams/project/index.md` 和当前任务单。文档引用必须使用真实路径或标准 Markdown 链接。
...
2. 先读 `.claude/ai-teams/rule/index.md`、`.claude/ai-teams/rule/agents/lead.md`、`.claude/ai-teams/rule/tasks/index.md` 和当前项目/任务入口。
