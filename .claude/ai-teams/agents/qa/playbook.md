---
id: "agents-qa-playbook"
title: "QA Playbook 指针"
type: "agent-playbook"
scope: "agent"
owner: "role"
status: active
...
- Agent 专属规则：[qa](../../security/agent-playbooks/qa.md)
...
- 本文件不复制规则本体；规则修订以 `security/agent-playbooks/qa.md`、`security/index.md` 和根 `playbook.md` 为准。
