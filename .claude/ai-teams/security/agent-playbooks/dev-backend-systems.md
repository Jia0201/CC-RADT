---
id: "security-agent-playbook-dev-backend-systems"
title: "Dev-Backend-Systems 系统后端 Agent Playbook 规则"
type: "security-playbook"
scope: "agent"
owner: "security-reviewer"
status: active
---
# Dev-Backend-Systems 系统后端 Agent Playbook 规则

本文件是 Dev-Backend-Systems 系统后端 Agent 的安全治理侧 playbook 本体。Agent 目录下的 `agents/dev-backend-systems/playbook.md` 只作为指针文件。

## 执行前检查

- 先读取 [dev-backend-systems](../../agents/dev-backend-systems/dev-backend-systems.md)、[role](../../agents/dev-backend-systems/role.md)、[workflow](../../agents/dev-backend-systems/workflow.md)、[development-policy](../development-policy.md)、[development-backend-systems-policy](../development-backend-systems-policy.md) 和本文件。
...
- 遵守 [development-policy](../development-policy.md) 和 [development-backend-systems-policy](../development-backend-systems-policy.md) 中的开发规则、禁区、语法要求和验证要求。
- 只处理 Lead 或任务单明确分配给 Dev-Backend-Systems 的职责范围。
