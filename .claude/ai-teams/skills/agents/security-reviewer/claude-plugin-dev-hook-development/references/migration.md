...
if ["$command" == *"rm -rf"*](../../../../../%22$command%22%20==%20*%22rm%20-rf%22*.md); then
...
if ["$file_path" == *".."*](../../../../../%22$file_path%22%20==%20*%22..%22*); then
  echo '{"decision": "deny", "reason": "Path traversal detected"}' >&2
  exit 2
fi

# Check for system paths
if ["*](../../../../../%22$file_path%22%20==%20%22/etc/%22*.md) || ["*](../../../../../%22$file_path%22%20==%20%22/sys/%22*.md); then
...
if [pwd|echo)$](../../../../../%22$command%22%20=~%20%5E(ls.md); then
...
**Before:**
```bash
if ["$command" == *"sudo"*](../../../../../%22$command%22%20==%20*%22sudo%22*.md); then
...
**Before:**
```bash
if [secret|key|token)$](../../../../../%22$file%22%20=~%20/.(env.md); then
