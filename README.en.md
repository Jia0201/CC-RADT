...
![Observer overview with two sessions and an activity timeline](.claude/ai-teams/assets/readme/observer/observer-multi-session.png)
...
![Task file and its evidence in the detail panel](.claude/ai-teams/assets/readme/observer/observer-task-evidence.png)

The task view opens the recorded file alongside the list. It does not execute the task.

![Existing review record displayed in the observer](.claude/ai-teams/assets/readme/observer/observer-review.png)
...
![Before-and-after code changes](.claude/ai-teams/assets/readme/observer/observer-code-changes.png)

![Safe Markdown in an Agent definition](.claude/ai-teams/assets/readme/observer/observer-markdown.png)
...
![Installed Skills and their content](.claude/ai-teams/assets/readme/observer/observer-skills.png)

![MCP services and redacted boundaries](.claude/ai-teams/assets/readme/observer/observer-mcp.png)

![The twelve declared workflow rules](.claude/ai-teams/assets/readme/observer/observer-workflows.png)
...
<img src=".claude/ai-teams/assets/readme/observer/observer-mobile.png" alt="Observer mobile layout" width="390">

<img src=".claude/ai-teams/assets/readme/observer/observer-markdown-mobile.png" alt="Safe Markdown on mobile" width="390">
...
The observer listens on `127.0.0.1`, uses a random access credential, and stores bounded history outside the project. Set `AI_TEAMS_OBSERVER=0` before starting Claude Code to disable automatic startup and recording. See the [observer guide](.claude/ai-teams/tools/observer/README.md) for retention, configuration, and limitations. The web UI does not execute commands, approve work, or change configuration.
...
![CC-RADT multi-agent delivery flow](.claude/ai-teams/assets/readme/cc-radt-workflow-en.png)
...
See [`.claude/ai-teams/agents/index.md`](.claude/ai-teams/agents/index.md) for the canonical team index. Claude Code-facing definitions live in `.claude/agents/`.
...
Selection rules and completion gates are defined in [`.claude/ai-teams/playbook.md`](.claude/ai-teams/playbook.md).

## Engineering Brain and Project Boundary

![CC-RADT engineering brain and project boundary](.claude/ai-teams/assets/readme/cc-radt-architecture-en.png)
...
See [`.claude/ai-teams/tools/commands/index.md`](.claude/ai-teams/tools/commands/index.md) for the full command index. High-risk tools require a plan or dry run first.
...
Start from [`.claude/ai-teams/index/ENTRY.md`](.claude/ai-teams/index/ENTRY.md) for the full map. See [`INSTALL.md`](INSTALL.md) for exact installation and configuration merge steps.
...
See [`.claude/ai-teams/THIRD_PARTY_NOTICES.md`](.claude/ai-teams/THIRD_PARTY_NOTICES.md) for bundled third-party Skill sources and licenses. CC-RADT is an independent open-source project and is not affiliated with or endorsed by Anthropic, OpenAI, or the Oh My OpenCode project. Product and project names belong to their respective owners.
