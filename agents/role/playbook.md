---
id: "agents-role-playbook"
title: "Role Playbook 指针"
type: "agent-playbook"
scope: "agent"
owner: "role"
status: active
...
- Agent 专属规则：[role](../../security/agent-playbooks/role.md)
...
- 本文件不复制规则本体；规则修订以 `security/agent-playbooks/role.md`、`security/index.md` 和根 `playbook.md` 为准。
