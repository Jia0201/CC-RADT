---
id: agents-dev-frontend-web-mcp
title: "Dev-Frontend-Web 前端 Web Agent MCP 指引"
type: agent-mcp
scope: project
owner: role
status: active
---
# Dev-Frontend-Web 前端 Web Agent MCP 指引

## 具体索引

- Agent MCP 索引：[index](../../mcp/agents/dev-frontend-web/index.md)
...
- `shadcn`（`ai-teams-shadcn`）：默认启用，配置文件 `.mcp.json`。Web 前端组件参考和 UI 实现辅助。
