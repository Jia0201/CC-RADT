---
id: "agents-security-reviewer-playbook"
title: "Security-Reviewer Playbook 指针"
type: "agent-playbook"
scope: "agent"
owner: "role"
status: active
---
# Security-Reviewer Playbook 指针

本文件仅作为 Agent 目录内的 playbook 索引/指针，不承载规则本体。

## 规则来源

- Agent 专属规则：[security-reviewer](../../security/agent-playbooks/security-reviewer.md)
...
- 本文件不复制规则本体；规则修订以 `security/agent-playbooks/security-reviewer.md`、`security/index.md` 和根 `playbook.md` 为准。
