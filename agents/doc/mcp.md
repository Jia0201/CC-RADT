---
id: agents-doc-mcp
title: "Doc 文档管理 Agent MCP 指引"
type: agent-mcp
scope: project
owner: role
status: active
---
# Doc 文档管理 Agent MCP 指引

## 具体索引

- Agent MCP 索引：[index](../../mcp/agents/doc/index.md)
...
- `canva`（`ai-teams-canva-remote`）：可选启用，配置文件 `mcp/optional-servers.mcp.example.json`。Canva 设计资产协作。
