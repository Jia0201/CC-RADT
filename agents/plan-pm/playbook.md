---
id: "agents-plan-pm-playbook"
title: "Plan-PM Playbook 指针"
type: "agent-playbook"
scope: "agent"
owner: "role"
status: active
...
- Agent 专属规则：[plan-pm](../../security/agent-playbooks/plan-pm.md)
...
- 本文件不复制规则本体；规则修订以 `security/agent-playbooks/plan-pm.md`、`security/index.md` 和根 `playbook.md` 为准。
