...
Create skills in `skills/agents/<agent>/<skill>/SKILL.md`. Some are also available via plugins:
...
#### [skill name]
**Why**: [specific reason]
**Create**: `skills/agents/<agent>/<skill>/SKILL.md`
