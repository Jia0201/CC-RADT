...
全局工作流选择器位于 [playbook.md 3.4](../playbook.md#3.4-工作流选择器)。Lead 先选 `WF-01` 到 `WF-12`，再决定是否需要任务单、并行监督、QA/Doc/Memory/Security/Role 档位和 Agent 组合。设计原因见 [ADR-0010](../project/adr/accepted/ADR-0010-workflow-selector.md)。
