---
id: "mcp-agents-dev-frontend-web-index"
title: "Dev-Frontend-Web 前端 Web Agent MCP 索引"
type: "mcp-index"
scope: "project"
owner: "doc"
status: active
---
# Dev-Frontend-Web 前端 Web Agent MCP 索引

## 读取顺序

1. [dev-frontend-web](../../../agents/dev-frontend-web/dev-frontend-web.md)
2. [mcp](../../../agents/dev-frontend-web/mcp.md)
3. [index](./index.md)
...
| `shadcn` | `ai-teams-shadcn` | 默认启用 | `.mcp.json` | Web 前端组件参考和 UI 实现辅助。 | 只用于组件参考；不得覆盖目标项目既有设计系统和样式规范。 |
