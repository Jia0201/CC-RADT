---
id: "security-agent-playbook-dev-frontend-miniapp"
title: "Dev-Frontend-Miniapp 小程序 Agent Playbook 规则"
type: "security-playbook"
scope: "agent"
owner: "security-reviewer"
status: active
---
# Dev-Frontend-Miniapp 小程序 Agent Playbook 规则

本文件是 Dev-Frontend-Miniapp 小程序 Agent 的安全治理侧 playbook 本体。Agent 目录下的 `agents/dev-frontend-miniapp/playbook.md` 只作为指针文件。

## 执行前检查

- 先读取 [dev-frontend-miniapp](../../agents/dev-frontend-miniapp/dev-frontend-miniapp.md)、[role](../../agents/dev-frontend-miniapp/role.md)、[workflow](../../agents/dev-frontend-miniapp/workflow.md)、[development-policy](../development-policy.md)、[development-frontend-miniapp-policy](../development-frontend-miniapp-policy.md) 和本文件。
...
- 遵守 [development-policy](../development-policy.md) 和 [development-frontend-miniapp-policy](../development-frontend-miniapp-policy.md) 中的开发规则、禁区、语法要求和验证要求。
- 只处理 Lead 或任务单明确分配给 Dev-Frontend-Miniapp 的职责范围。
